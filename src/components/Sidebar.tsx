      ...
      `}>
        <div className=" p-6 pt-20 lg:pt-6">
          <nav className="space-y-2">
            {/* Peta Button - External Link */}
            <button
              onClick={handlePetaTBMClick}
              className="flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left text-amber-700 hover:bg-A1-Forest hover:bg-opacity-50 hover:text-white"
            >
